...
At [Cloudmanic Labs](https://cloudmanic.com?utm_source=feasible.lol), we'd spent years looking for analytics we liked. We started with Google Analytics, where checking a few numbers always seemed to require more work than it should. We moved to <a href="https://clicky.com/" rel="nofollow">Clicky</a> and happily paid for it. It was great for a while, then became less of a fit. After that, we hosted <a href="https://matomo.org/" rel="nofollow">Matomo</a> ourselves.
