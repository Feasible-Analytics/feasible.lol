...
If you're weighing it up, [the head-to-head is here](/compare/google-analytics/) and [the price is here](/pricing/). If you're staying on GA4 — plenty of people should, and the BigQuery export is genuinely good — export your data on a schedule anyway. July 2024 is the argument for that, and Google made it.
