...
**Most sites running Feasible won't need a consent banner.** The UK now has a statutory exemption written for exactly this, and the practices it describes are the practices we implement. Elsewhere in the EU it's a strong case rather than a settled one.
