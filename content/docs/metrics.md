...
- **Bounce rate** - the share of visits with one pageview and no other interaction. An
...
under two sources, and every total on the page would be larger than the traffic that happened. If you need the newsletter credited, it has to be the visit's first pageview - which in
