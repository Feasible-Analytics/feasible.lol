...
platform: "WordPress"
description: "Paste one script tag into your WordPress header, via a header-scripts plugin or the Feasible plugin. No cookies, so most sites won't need a banner."
