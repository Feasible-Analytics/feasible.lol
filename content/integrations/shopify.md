...
platform: "Shopify"
description: "Paste one script tag into theme.liquid before the closing head tag. Works on every Shopify plan, with one honest limit around checkout."
...
What this actually costs you is less than it sounds. You still see every product page, collection and cart, every source and campaign that brought the visit, and — if you set up a [revenue goal](/docs/goals-funnels/) — the money, credited back to the source that started the visit rather than to Shopify Payments.
