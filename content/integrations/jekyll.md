...
The dev server runs on `localhost`, which is not counted. That's why your own writing sessions never appear in your numbers. Check on the published site instead.
{{< /callout >}}
...
## Register the hostname you serve
