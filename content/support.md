...
- **The site's domain**, exactly as it's set up in Feasible.
...
- **When it happened**, with a timezone. Our clocks are UTC underneath and your site
  has its own timezone setting, so "yesterday afternoon" is genuinely ambiguous.
...
**Security problems** go to [help@feasible.lol](mailto:help@feasible.lol) as well —
not to a public issue, please. [How we handle them, and what we don't have](/security/).

## Feature requests

Send them. We read all of them and we say no to a lot of them, usually with a reason.

Feasible is deliberately a small product — one page, the numbers most people actually
look at, and not much else. Some of the things people ask for are things we've decided
