---
title: "Security"
seotitle: "Security — what Feasible actually does"
...
lede: "What we actually do, in specifics — and an honest list of the things we don't have."
---
...
A password-protected dashboard **deliberately can't be embedded** in an iframe. An
...
key** and show you the real thing exactly once — if you lose it, we can't recover it,
