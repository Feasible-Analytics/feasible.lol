...
A shielded event is refused and counted with its reason, not silently dropped - the health panel shows `shield_ip`, `shield_country` and `shield_page` as separate lines, so you can always see what a rule is costing you.
