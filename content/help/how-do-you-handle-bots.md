...
4. **Outdated browser.** A narrow rule that only fires when a browser is more than eighteen major versions behind on a self-updating platform. It's aimed at spoofed agents, not at your one visitor who won't restart Chrome.
