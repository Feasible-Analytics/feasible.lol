...
- **`data-domain` matches the site you registered.** Not the full URL, not with `www.`, just the domain.
- **Every page, not just the home page.** A tag on the home page only means your top-pages report will have exactly one row in it.
