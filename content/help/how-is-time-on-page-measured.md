...
Only while the tab is actually visible and actually focused.
...
Two related numbers, easy to mix up:
...
The thing it can't do is measure someone who's looking at the screen without touching anything — reading is invisible to a browser. Nothing measures that, here or anywhere. Focus time is the closest honest proxy, which is why it's the one we use.
