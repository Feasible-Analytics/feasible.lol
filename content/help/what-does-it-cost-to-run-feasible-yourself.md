...
What it actually costs you is time, and that's the honest comparison. Upgrades, TLS renewals, disk alarms, the 2am one. If your answer to that is "fine, I already run servers", self-hosting is genuinely cheap. If it's "I'd rather not", [$9.99 a month](/pricing/) is the alternative and it's the same software.
