...
**Filtered events are counted, not deleted.** You can see how much spam you got and when it started, which is more useful than a report that never mentions it. If your traffic looks strange, that count is often the explanation.
