...
**Outside your team**, there are three ways data leaves, and all three are things you turn on:
...
A password-protected shared link can't be embedded in an iframe. Serving a password form without frame protection is how you get it clickjacked, so we refuse the combination rather than let you set up something that looks safe and isn't.
