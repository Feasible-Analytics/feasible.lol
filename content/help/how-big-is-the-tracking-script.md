...
description: "3,569 bytes gzipped. 7,490 raw. That's the whole thing - there's no second file it pulls in afterwards."
category: "installing"
weight: 10
---

**3,569 bytes gzipped.** 7,490 bytes raw.

That's the complete script, not a loader that fetches the real one afterwards. One request, and it's over.

For scale: it's about 42× smaller than Google Analytics' tag on the wire. On a slow connection that's the difference between a measurable delay and nothing you could detect with a stopwatch.
