...
- **`Outbound Link: Click`** - somebody clicked a link to another domain. Carries the destination as a `url` property, so you can see where your traffic goes.
- **`File Download`** - a PDF, a zip, an installer. Recognized by extension.
