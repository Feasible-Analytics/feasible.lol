...
2. **Read the drop counts on the health panel.** [Every refused event has a named reason](/help/why-are-my-events-being-dropped/). On a site with backlinks, bot filtering alone is often 20–40% of raw requests, and it's usually the entire gap on its own.
