...
The first three each get a tab in the **Top Sources** card, under **Campaigns**. Those tabs deliberately exclude untagged traffic, so a campaign report is only ever campaigns — no giant "(none)" row swamping the thing you're trying to read.
