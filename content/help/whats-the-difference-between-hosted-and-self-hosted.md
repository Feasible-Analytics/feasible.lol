...
Who runs the server. That's the whole difference.
...
Pick self-hosted if you already run servers, or if the data can't leave your jurisdiction, or if you just want to. [What it costs to run](/help/what-does-it-cost-to-run-feasible-yourself/) is a small VPS.
